...
| `BLSEconomicSurveysCes` | US Bureau of Labor Statistics (BLS) | py`value`cs`Value` |
| `BLSEconomicSurveysCpi` | US Bureau of Labor Statistics (BLS) | py`value`cs`Value` |
| `BLSEconomicSurveysJolts` | US Bureau of Labor Statistics (BLS) | py`value`cs`Value` |
| `BLSEconomicSurveysPpi` | US Bureau of Labor Statistics (BLS) | py`value`cs`Value` |
