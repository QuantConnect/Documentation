<p>The optimization nodes that backtest your algorithm are not the <a href="/docs/v2/cloud-platform/organizations/resources#02-Backtesting-Nodes">backtesting nodes</a> in your organization. The optimization nodes are a cluster of nodes that exclusively run optimization jobs. The optimization can concurrently run multiple backtests if you use multiple nodes, but the maximum number of nodes you can use depends on the node type. The following table describes the node types:</p> 
...
<p>The following table shows the <a href="/docs/v2/cloud-platform/organizations/resources#08-Training-Quotas">training quotas</a> of the optimization node types:</p>
