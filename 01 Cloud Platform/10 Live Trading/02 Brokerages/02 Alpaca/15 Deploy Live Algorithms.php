...
$dataProviderDetails = "<p>In most cases, we suggest using the <a href='/docs/v2/cloud-platform/datasets'>QuantConnect data provider</a>, the <a href='/docs/v2/cloud-platform/datasets/alpaca'>Alpaca data provider</a>, or both. The order you set them in the deployment wizard defines their order of precedence in Lean.</p><p>If you add Alpaca data provider, enter your API key and secret. To get your API key and secret, see the Create an Account section in the <a href='/docs/v2/cloud-platform/live-trading/brokerages/alpaca#02-Account-Types'>Account Types</a> documentation. Your account details are not saved on QuantConnect.</p>";
$postDeploy = "";
