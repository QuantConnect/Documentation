...
$holdingsState = false;
$secondBullet = "";
$authentication = "<li>Enter your Clear Street access token and account ID.</li>" . file_get_contents(DOCS_RESOURCES."/brokerages/create-credentials/clear-street.html");
$postDeploy = "";
