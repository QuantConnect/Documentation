...
<ol>
    ...
    <li>If the security you want to trade still isn't listed, <a href='/docs/v2/cloud-platform/live-trading/algorithm-control#02-Add-Security-Subscriptions'>subscribe to the security</a>.</li>
