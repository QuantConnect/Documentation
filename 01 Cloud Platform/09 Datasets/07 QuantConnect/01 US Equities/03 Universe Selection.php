...
<div class="section-example-container">
    <pre class="csharp">// Set universe to asynchronous and add fundamental universe.
UniverseSettings.Asynchronous = true;
AddUniverse(SelectFundamental);</pre>
    <pre class="python"># Set universe to asynchronous and add fundamental universe.
...
<div class="section-example-container">
    <pre class="csharp">// Enable asynchronous universe, add SPY equity, and add ETF universe to match constituents of SPY
UniverseSettings.Asynchronous = true;
var spy = AddEquity("SPY").Symbol;
AddUniverse(Universe.ETF(spy, UniverseSettings, ETFConstituentsFilter));</pre>
    <pre class="python"># Enable asynchronous universe, add SPY equity, and add ETF universe to match constituents of SPY
self.universe_settings.asynchronous = True
