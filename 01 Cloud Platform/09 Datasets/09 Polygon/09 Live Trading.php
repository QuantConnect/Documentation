<p>The following sections explain live trading deployment, universe selection, and alternative data when using the Polygon data provider.</p>
...
<ol>
    ...
    <p>For more information about the required information for each brokerage, see the <span class='page-section-name'>Deploy Live Algorithms</span> section of your <a href='/docs/v2/cloud-platform/live-trading/brokerages'>brokerage documenation</a>.</p>
...
<p>When you trade live on QuantConnect Cloud with the Polygon data provider, QuantConnect provides the <a href='/docs/v2/writing-algorithms/universes/key-concepts'>universe selection</a> data.</p>
