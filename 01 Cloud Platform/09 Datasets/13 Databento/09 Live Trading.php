...
<p>Follow these steps to deploy a live trading algorithm that uses the Databento data provider:</p>
...
<ol>
    ...
    <li>Click the <span class='field-name'>Data Provider 1</span> field and then click <span class='button-name'>Databento</span> from the drop-down menu.</li>
    <li>Enter your Databento API Key.</li>
    <img class='docs-image' src='https://cdn.quantconnect.com/i/tu/databento-data-provider.png' alt='Databento selected as the data provider in the deployment wizard'>
