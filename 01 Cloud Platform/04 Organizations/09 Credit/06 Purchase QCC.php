...
<ol>
    ...
    <li>If your preferred organization doesn't have a credit card, enter the credit card details and then click <span class="button-name">Purchase</span>.</li>
        <p>Only the preferred organization can be charged when purchasing QCC. If you want to charge a different organization you are a member of, <a href="/docs/v2/cloud-platform/organizations/administration#10-Set-a-Preferred-Organization">set it as your preferred organization</a>.</p>
</ol>