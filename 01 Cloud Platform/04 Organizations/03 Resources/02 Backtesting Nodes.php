...
<p>By default, the best-performing resource is selected when you run a backtest, but you can <a href='/docs/v2/cloud-platform/projects/ide#07-Manage-Nodes'>select a specific resource to use</a>.</p>
