...
<p>
    ...
    Each target's <code class='csharp'>Quantity</code><code class='python'>quantity</code> value is treated as the portfolio weight (percentage of holdings), so you should pass percentage-based targets
