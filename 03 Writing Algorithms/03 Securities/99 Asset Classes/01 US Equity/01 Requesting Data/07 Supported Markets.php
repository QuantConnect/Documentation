...
<p>To set the market for a security, pass a <code>market</code> argument to the <code class="csharp">AddEquity</code><code class="python">add_equity</code> method.</p>

<div class="section-example-container">
    <pre class="csharp">_symbol = AddEquity("SPY", market: Market.USA).Symbol;</pre>
    <pre class="python">self._symbol = self.add_equity("SPY", market=Market.USA).symbol</pre>
</div>
