<p>The only market available for Forex pairs is <code>Market.Oanda</code>, so you don't need to pass a <code>market</code> argument to the <code class="csharp">AddForex</code><code class="python">add_forex</code> method.</p>
