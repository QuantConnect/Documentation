...
$calculationMethod = "To calculate the values, we use <a href='/research/16977/greeks-and-iv-implementation/p1'>our implementation</a> the forward tree pricing model, which accounts for the interest rate and dividend payments.";
