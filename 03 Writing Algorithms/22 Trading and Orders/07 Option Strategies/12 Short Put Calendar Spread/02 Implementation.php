<p>Follow these steps to implement the short put calendar spread strategy:</p>
        ...
        <pre class="csharp">public override void OnData(Slice slice)
{
    ...
    <li>In the <code>OnData</code> method, call the <code>OptionStrategies.ShortPutCalendarSpread</code> method and then submit the order.</li>
    <div class="section-example-container">
...
Buy(optionStrategy, 1);</pre>
        <pre class="python">option_strategy = OptionStrategies.ShortPutCalendarSpread(self.symbol, atm_strike, near_expiry, far_expiry)
