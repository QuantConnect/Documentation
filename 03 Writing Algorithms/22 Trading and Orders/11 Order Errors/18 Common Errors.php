...
<pre class="csharp">// Check the market status before placing an order to avoid unintended market-on-open trades 
if (IsMarketOpen(_symbol))
{
    MarketOrder(symbol, quantity);
}</pre>
<pre class="python"># Check the market status before placing an order to avoid unintended market-on-open trades.
