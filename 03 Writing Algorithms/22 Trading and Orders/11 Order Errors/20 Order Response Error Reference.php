...
<p>To avoid this order response error, check the <code class='csharp'>Status</code><code class='python'>status</code> of an <a href='/docs/v2/writing-algorithms/trading-and-orders/order-management/order-tickets'>order ticket</a> or <a href='/docs/v2/writing-algorithms/trading-and-orders/order-events'>order event</a> before you update or cancel the order.</p>
...
<p>The <code class='csharp'>OrderResponseErrorCode.MarketOnOpenNotAllowedDuringRegularHours</code><code class='python'>OrderResponseErrorCode.MARKET_ON_OPEN_NOT_ALLOWED_DURING_REGULAR_HOURS</code> (-35) error occurs when you try to place a <a href='/docs/v2/writing-algorithms/trading-and-orders/order-types/market-on-open-orders'>market on open order</a> for an asset when it's during regular trading hours.</p>
