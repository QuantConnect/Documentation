...
<p>The default value is <code>DataNormalizationMode.<span class="csharp">Adjusted</span><span class="python">ADJUSTED</span></code>. To change the data normalization mode, in the <a href='/docs/v2/writing-algorithms/initialization'><span class="csharp">Initialize</span><span class="python">initialize</span></a> method, adjust the algorithm's <code>UniverseSettings</code> before you create the Universe Selection model.</p>
