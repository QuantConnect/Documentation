...
<table class="qc-table table">
    ...
    <tbody>
	    ...
	    <td><code class="csharp">Func&lt;DateTime, IEnumerable&lt;Symbol&gt;&gt;</code></td>
            <td>A function that selects the Future symbols. To view the supported assets in the US Futures dataset, see <a href='/docs/v2/writing-algorithms/datasets/algoseek/us-futures#05-Supported-Assets'>Supported Assets</a>.<br></td>
            <td></td>
        </tr>
        <tr>
