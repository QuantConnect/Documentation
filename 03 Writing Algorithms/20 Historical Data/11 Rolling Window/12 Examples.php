...
<p>The following algorithm trades the second derivative of EMA indicated trend, more specially, the difference between lagged EMA values. If the daily EMA difference is increasing while being lower than the current price, we estimate the uptrend is accelerating, hence buying SPY. Otherwise, if the price is below the EMA while the daily EMA difference is decelerating, we short SPY.</p>
<div class="section-example-container">
    <pre class="csharp">public class RollingWindowAlgorithm : QCAlgorithm
{
    private Symbol _spy;
