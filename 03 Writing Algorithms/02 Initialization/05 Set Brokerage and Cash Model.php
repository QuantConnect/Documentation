...
<div class="section-example-container">
	<pre class="csharp">// Set the brokerage model and account type to model fees, supported order types, and margin available. 
SetBrokerageModel(BrokerageName.InteractiveBrokersBrokerage, AccountType.Margin);</pre>
	<pre class="python"># Set the brokerage model and account type to model fees, supported order types, and margin available.
