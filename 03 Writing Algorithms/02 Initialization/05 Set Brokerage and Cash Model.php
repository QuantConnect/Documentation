...
<div class="section-example-container">
	<pre class="csharp">// Set the brokerage model and account type to simulate fees, supported order types, and margin available. 
SetBrokerageModel(BrokerageName.InteractiveBrokersBrokerage, AccountType.Margin);</pre>
	<pre class="python"># Set the brokerage model and account type to simulate fees, supported order types, and margin available.
self.set_brokerage_model(BrokerageName.INTERACTIVE_BROKERS_BROKERAGE, AccountType.CASH)</pre>
</div>
