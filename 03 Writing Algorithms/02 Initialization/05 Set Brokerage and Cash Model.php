...
<div class="section-example-container">
	<pre class="csharp">// Configure leverage availability and brokerage-specific trading conditions.
SetBrokerageModel(BrokerageName.InteractiveBrokersBrokerage, AccountType.Margin);</pre>
	<pre class="python"># Configure leverage availability and brokerage-specific trading conditions.
