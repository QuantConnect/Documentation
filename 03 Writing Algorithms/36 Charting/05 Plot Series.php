...
<div class="section-example-container">
    <pre class="csharp">// To visualize values on the chart call the Plot method to add a data point to a chart series.
Plot("&lt;chartName&gt;", "&lt;seriesName&gt;", value);</pre>
    <pre class="python"># To visualize values on the chart call the plot method to add a data point to a chart series.
self.plot("&lt;chartName&gt;", "&lt;seriesName&gt", value)</pre>
</div>
