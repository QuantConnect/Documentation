...
<div class="section-example-container">
    <pre class="csharp">// Enable extended market hours in non-derivative universe by adjusting the ExtendedMarketHours property in UniverseSettings object.
UniverseSettings.ExtendedMarketHours = true;
AddUniverse(Universe.DollarVolume.Top(50));</pre>
    <pre class="python"># Enable extended market hours in non-derivative universe by adjusting the extended_market_hours field in universe_settings object.
...
<div class="section-example-container">
    <pre class="csharp">// Enable extended market hours in derivative universe by passing extendedMarketHours argument to the AddFuture method.
AddFuture(Futures.Currencies.BTC, extendedMarketHours: true);</pre>
    <pre class="python"># Enable extended market hours in derivative universe by passing extended_market_hours argument to the add_future method.
