...
<div class="section-example-container">
    <pre class="csharp"> // Disabling getting historical data with corporate actions (dividends, splits, symbol changes, etc.) accounted for in universe.
...
AddUniverse(Universe.DollarVolume.Top(50));</pre>
    <pre class="python"> # Disabling getting historical data with corporate actions (dividends, splits, symbol changes, etc.) accounted for in universe.
