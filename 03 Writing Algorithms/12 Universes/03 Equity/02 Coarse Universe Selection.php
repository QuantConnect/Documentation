...
<p>The total number of stocks in the <a href='/datasets/quantconnect-us-equity-security-master'>US Equity Security Master dataset</a> is <? include(DOCS_RESOURCES."/kpis/us-equity-security-master-size.php");?> but your coarse filter function won't receive all of these at one time because the US Equity Security Master dataset is free of survivorship bias and some of the securities have delisted over time. The number of securities that are passed into your coarse filter function depends on the date of your algorithm. Currently, there are about <? include(DOCS_RESOURCES."/kpis/coarse-universe-size.php"); ?> securities that LEAN passes into your coarse filter function.</p>
