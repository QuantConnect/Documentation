...
echo file_get_contents(DOCS_RESOURCES."/qcalgorithm-api/set-pandas-converter.html");
...
echo file_get_contents(DOCS_RESOURCES."/qcalgorithm-api/set-statistics-service.html");
