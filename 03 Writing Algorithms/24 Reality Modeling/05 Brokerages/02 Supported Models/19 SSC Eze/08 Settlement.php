<p>The following table shows which <a href='/docs/v2/writing-algorithms/reality-modeling/settlement/key-concepts'>settlement model</a> the <code>EzeBrokerageModel</code> uses based on the security type and your account type:</p>

<? 
$includeLinks = true;
$brokerageModelName = "EzeBrokerageModel";
