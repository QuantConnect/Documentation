<p>To set the assignment model of an Option, call the <code>SetOptionAssignmentModel</code> method of the <code>Option</code> object inside a <a href='/docs/v2/writing-algorithms/initialization#07-Set-Security-Initializer'>security initializer</a>.</p>
