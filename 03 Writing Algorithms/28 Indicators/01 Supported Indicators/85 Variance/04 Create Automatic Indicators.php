...
<p>The VAR method creates an Variance indicator, sets up a consolidator to update the indicator, and then returns the indicator so you can use it in your algorithm.</p>
<p>The following reference table describes the <code>VAR</code> method:</p>

<? include(DOCS_RESOURCES."/qcalgorithm-api/var.html"); ?>
<br/>
