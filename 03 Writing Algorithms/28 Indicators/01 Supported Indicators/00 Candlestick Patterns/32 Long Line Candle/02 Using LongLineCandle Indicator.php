...
<p>For more information about this method, see the <a class='csharp' href="https://www.lean.io/docs/v2/lean-engine/class-reference/cs/classQuantConnect_1_1Algorithm_1_1CandlestickPatterns.html">CandlestickPatterns class</a><a class='python' href="https://www.lean.io/docs/v2/lean-engine/class-reference/py/QuantConnect/Algorithm/CandlestickPatterns/#QuantConnect.Algorithm.CandlestickPatterns.long_line_candle">CandlestickPatterns class</a>.</p>
...
<pre class="python">class LongLineCandleAlgorithm(QCAlgorithm):
    ...
    def on_data(self, slice: Slice) -> None:
        ...
        if self._long_line_candle.is_ready:
            # The current value of self._long_line_candle is represented by self._long_line_candle.current.value
            self.plot("LongLineCandle", "long_line_candle", self._long_line_candle.current.value)</pre></div>
<p>For more information about this indicator, see its <a class='csharp' href="https://www.lean.io/docs/v2/lean-engine/class-reference/cs/classQuantConnect_1_1Indicators_1_1CandlestickPatterns_1_1LongLineCandle.html">reference</a><a class='python' href="https://www.lean.io/docs/v2/lean-engine/class-reference/py/QuantConnect/Indicators/CandlestickPatterns/LongLineCandle">reference</a>.</p>