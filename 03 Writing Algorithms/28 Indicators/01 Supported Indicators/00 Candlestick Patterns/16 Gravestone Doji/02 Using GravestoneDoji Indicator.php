...
<p>For more information about this method, see the <a rel="nofollow" target="_blank" class='csharp' href="https://www.lean.io/docs/v2/lean-engine/class-reference/cs/classQuantConnect_1_1Algorithm_1_1CandlestickPatterns.html">CandlestickPatterns class</a><a rel="nofollow" target="_blank" class='python' href="https://www.lean.io/docs/v2/lean-engine/class-reference/py/QuantConnect/Algorithm/CandlestickPatterns/#QuantConnect.Algorithm.CandlestickPatterns.gravestone_doji">CandlestickPatterns class</a>.</p>
...
<pre class="python">class GravestoneDojiAlgorithm(QCAlgorithm):
    ...
    def on_data(self, slice: Slice) -> None:
        ...
        if self._gravestone_doji.is_ready:
            # The current value of self._gravestone_doji is represented by self._gravestone_doji.current.value
            self.plot("GravestoneDoji", "gravestone_doji", self._gravestone_doji.current.value)</pre></div>
<p>For more information about this indicator, see its <a rel="nofollow" target="_blank" class='csharp' href="https://www.lean.io/docs/v2/lean-engine/class-reference/cs/classQuantConnect_1_1Indicators_1_1CandlestickPatterns_1_1GravestoneDoji.html">reference</a><a rel="nofollow" target="_blank" class='python' href="https://www.lean.io/docs/v2/lean-engine/class-reference/py/QuantConnect/Indicators/CandlestickPatterns/GravestoneDoji">reference</a>.</p>