...
<p>For more information about this method, see the <a class='csharp' href="https://www.lean.io/docs/v2/lean-engine/class-reference/cs/classQuantConnect_1_1Algorithm_1_1CandlestickPatterns.html">CandlestickPatterns class</a><a class='python' href="https://www.lean.io/docs/v2/lean-engine/class-reference/py/QuantConnect/Algorithm/CandlestickPatterns/#QuantConnect.Algorithm.CandlestickPatterns.inverted_hammer">CandlestickPatterns class</a>.</p>
...
<pre class="python">class InvertedHammerAlgorithm(QCAlgorithm):
    ...
    def on_data(self, slice: Slice) -> None:
        ...
        if self._inverted_hammer.is_ready:
            # The current value of self._inverted_hammer is represented by self._inverted_hammer.current.value
            self.plot("InvertedHammer", "inverted_hammer", self._inverted_hammer.current.value)</pre></div>
<p>For more information about this indicator, see its <a class='csharp' href="https://www.lean.io/docs/v2/lean-engine/class-reference/cs/classQuantConnect_1_1Indicators_1_1CandlestickPatterns_1_1InvertedHammer.html">reference</a><a class='python' href="https://www.lean.io/docs/v2/lean-engine/class-reference/py/QuantConnect/Indicators/CandlestickPatterns/InvertedHammer">reference</a>.</p>