...
<p>For more information about this method, see the <a class='csharp' href="https://www.lean.io/docs/v2/lean-engine/class-reference/cs/classQuantConnect_1_1Algorithm_1_1CandlestickPatterns.html">CandlestickPatterns class</a><a class='python' href="https://www.lean.io/docs/v2/lean-engine/class-reference/py/QuantConnect/Algorithm/CandlestickPatterns/#QuantConnect.Algorithm.CandlestickPatterns.up_down_gap_three_methods">CandlestickPatterns class</a>.</p>
...
<pre class="python">class UpDownGapThreeMethodsAlgorithm(QCAlgorithm):
    ...
    def on_data(self, slice: Slice) -> None:
        ...
        if self._up_down_gap_three_methods.is_ready:
            # The current value of self._up_down_gap_three_methods is represented by self._up_down_gap_three_methods.current.value
            self.plot("UpDownGapThreeMethods", "up_down_gap_three_methods", self._up_down_gap_three_methods.current.value)</pre></div>
<p>For more information about this indicator, see its <a class='csharp' href="https://www.lean.io/docs/v2/lean-engine/class-reference/cs/classQuantConnect_1_1Indicators_1_1CandlestickPatterns_1_1UpDownGapThreeMethods.html">reference</a><a class='python' href="https://www.lean.io/docs/v2/lean-engine/class-reference/py/QuantConnect/Indicators/CandlestickPatterns/UpDownGapThreeMethods">reference</a>.</p>