...
<pre class="python">class MoneyFlowIndexAlgorithm(QCAlgorithm):
    def initialize(self) -> None:
        ...
        positive_money_flow = indicator_history_df["positive_money_flow"]
        negative_money_flow = indicator_history_df["negative_money_flow"]</pre></div>