...
<pre class="python">class ArmsIndexAlgorithm(QCAlgorithm):
    def initialize(self) -> None:
        ...
        adv_ratio = indicator_history_df["adv_ratio"]</pre></div>