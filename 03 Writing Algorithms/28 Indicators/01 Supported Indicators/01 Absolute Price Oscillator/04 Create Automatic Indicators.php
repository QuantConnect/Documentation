...
<p>The APO method creates an AbsolutePriceOscillator indicator, sets up a consolidator to update the indicator, and then returns the indicator so you can use it in your algorithm.</p>
<p>The following reference table describes the <code>APO</code> method:</p>
