...
<pre class="python">class AverageDirectionalIndexAlgorithm(QCAlgorithm):
    def initialize(self) -> None:
        ...
        negative_directional_index = indicator_history_df["negative_directional_index"]</pre></div>