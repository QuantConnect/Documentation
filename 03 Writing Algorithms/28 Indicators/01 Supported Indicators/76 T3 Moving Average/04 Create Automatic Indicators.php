...
<p>The T3 method creates an T3MovingAverage indicator, sets up a consolidator to update the indicator, and then returns the indicator so you can use it in your algorithm.</p>
<p>The following reference table describes the <code>T3</code> method:</p>

<? include(DOCS_RESOURCES."/qcalgorithm-api/t3.html"); ?>
<br/>
