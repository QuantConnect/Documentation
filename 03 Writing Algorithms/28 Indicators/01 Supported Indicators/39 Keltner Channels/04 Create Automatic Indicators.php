...
<p>The KCH method creates an KeltnerChannels indicator, sets up a consolidator to update the indicator, and then returns the indicator so you can use it in your algorithm.</p>
<p>The following reference table describes the <code>KCH</code> method:</p>
