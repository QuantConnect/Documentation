...
<pre class="python">class McClellanSummationIndexAlgorithm(QCAlgorithm):
    def initialize(self) -> None:
        ...
        mc_clellan_oscillator = indicator_history_df["mc_clellan_oscillator"]</pre></div>