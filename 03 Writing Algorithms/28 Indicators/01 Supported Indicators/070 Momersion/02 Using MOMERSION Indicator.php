...
<p>For more information about this method, see the <a class='csharp' href="https://www.lean.io/docs/v2/lean-engine/class-reference/cs/classQuantConnect_1_1Algorithm_1_1QCAlgorithm.html">QCAlgorithm class</a><a class='python' href="https://www.lean.io/docs/v2/lean-engine/class-reference/py/QuantConnect/Algorithm/QCAlgorithm/#QuantConnect.Algorithm.QCAlgorithm.momersion">QCAlgorithm class</a>.</p>
...
&rcub;</pre>
    ...
    def on_data(self, slice: Slice) -> None:
        ...
        if self._momersion.is_ready:
            # The current value of self._momersion is represented by self._momersion.current.value
            self.plot("Momersion", "momersion", self._momersion.current.value)</pre></div>
<p>For more information about this indicator, see its <a class='csharp' href="https://www.lean.io/docs/v2/lean-engine/class-reference/cs/classQuantConnect_1_1Indicators_1_1Momersion.html">reference</a><a class='python' href="https://www.lean.io/docs/v2/lean-engine/class-reference/py/QuantConnect/Indicators/Momersion">reference</a>.</p>