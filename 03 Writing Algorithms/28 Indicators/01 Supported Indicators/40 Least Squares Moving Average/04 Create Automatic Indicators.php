...
<p>The LSMA method creates an LeastSquaresMovingAverage indicator, sets up a consolidator to update the indicator, and then returns the indicator so you can use it in your algorithm.</p>
<p>The following reference table describes the <code>LSMA</code> method:</p>
