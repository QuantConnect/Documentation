...
<pre class="python">class AverageTrueRangeAlgorithm(QCAlgorithm):
    def initialize(self) -> None:
        ...
        True_range = indicator_history_df["True_range"]</pre></div>