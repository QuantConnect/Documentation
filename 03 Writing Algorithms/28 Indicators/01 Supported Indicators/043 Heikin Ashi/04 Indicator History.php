...
<pre class="python">class HeikinAshiAlgorithm(QCAlgorithm):
    def initialize(self) -> None:
        ...
        volume = indicator_history_df["volume"]</pre></div>