...
<pre class="python">class ZigZagAlgorithm(QCAlgorithm):
    ...
    def on_data(self, slice: Slice) -> None:
        ...
        if self._zz.is_ready:
            ...
            self.plot("ZigZag", "pivot_type", self._zz.pivot_type.current.value)</pre></div>
<p>For more information about this method, see the <a class='csharp' href="https://www.lean.io/docs/v2/lean-engine/class-reference/cs/classQuantConnect_1_1Algorithm_1_1QCAlgorithm.html">QCAlgorithm class</a><a class='python' href="https://www.lean.io/docs/v2/lean-engine/class-reference/py/QuantConnect/Algorithm/QCAlgorithm/#QuantConnect.Algorithm.QCAlgorithm.zz">QCAlgorithm class</a>.</p>
...
&lcub;
    ...
    &lcub;
        ...
        &lcub;
            ...
            Plot("ZigZag", "pivottype", _zigzag.PivotType);
        &rcub;
    &rcub;
&rcub;</pre>
<pre class="python">class ZigZagAlgorithm(QCAlgorithm):
    ...
    def on_data(self, slice: Slice) -> None:
        ...
        if self._zigzag.is_ready:
            ...
            self.plot("ZigZag", "low_pivot", self._zigzag.low_pivot.current.value)
            self.plot("ZigZag", "pivot_type", self._zigzag.pivot_type.current.value)</pre></div>
<p>For more information about this indicator, see its <a class='csharp' href="https://www.lean.io/docs/v2/lean-engine/class-reference/cs/classQuantConnect_1_1Indicators_1_1ZigZag.html">reference</a><a class='python' href="https://www.lean.io/docs/v2/lean-engine/class-reference/py/QuantConnect/Indicators/ZigZag">reference</a>.</p>