...
<pre class="python">class McClellanOscillatorAlgorithm(QCAlgorithm):
    def initialize(self) -> None:
        ...
        ema_fast = indicator_history_df["ema_fast"]
        ema_slow = indicator_history_df["ema_slow"]
        ad_difference = indicator_history_df["ad_difference"]</pre></div>