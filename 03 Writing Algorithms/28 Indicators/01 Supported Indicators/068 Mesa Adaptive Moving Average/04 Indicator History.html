...
<pre class="python">class MesaAdaptiveMovingAverageAlgorithm(QCAlgorithm):
    def initialize(self) -> None:
        ...
        fama = indicator_history_df["fama"]</pre></div>