...
<p>The FilteredIdentity method creates an FilteredIdentity indicator, sets up a consolidator to update the indicator, and then returns the indicator so you can use it in your algorithm.</p>
<p>The following reference table describes the <code>FilteredIdentity</code> method:</p>

<? include(DOCS_RESOURCES."/qcalgorithm-api/filteredidentity.html"); ?>
<br/>
