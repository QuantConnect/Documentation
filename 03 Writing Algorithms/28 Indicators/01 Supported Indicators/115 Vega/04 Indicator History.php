...
<pre class="python">class VegaAlgorithm(QCAlgorithm):
    def initialize(self) -> None:
        ...
        time_period_indicator_history = self.indicator_history(self._v, [self._symbol, self._option, self._mirror_option], datetime(2024, 7, 1), datetime(2024, 7, 5), Resolution.MINUTE)</pre></div>