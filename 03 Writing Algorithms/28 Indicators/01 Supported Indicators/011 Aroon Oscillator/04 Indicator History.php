...
<pre class="python">class AroonOscillatorAlgorithm(QCAlgorithm):
    def initialize(self) -> None:
        ...
        aroon_up = indicator_history_df["aroon_up"]
        aroon_down = indicator_history_df["aroon_down"]</pre></div>