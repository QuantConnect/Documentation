...
<p>The SWISS method creates an SwissArmyKnife indicator, sets up a consolidator to update the indicator, and then returns the indicator so you can use it in your algorithm.</p>
<p>The following reference table describes the <code>SWISS</code> method:</p>

<? include(DOCS_RESOURCES."/qcalgorithm-api/swiss.html"); ?>
<br/><? include(DOCS_RESOURCES."/enumerations/swiss_army_knife_tool.html"); ?>
