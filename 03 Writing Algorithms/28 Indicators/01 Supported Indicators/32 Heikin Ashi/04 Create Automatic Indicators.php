...
<p>The HeikinAshi method creates an HeikinAshi indicator, sets up a consolidator to update the indicator, and then returns the indicator so you can use it in your algorithm.</p>
<p>The following reference table describes the <code>HeikinAshi</code> method:</p>

<? include(DOCS_RESOURCES."/qcalgorithm-api/heikinashi.html"); ?>
<br/>
