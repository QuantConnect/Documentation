...
<div class="csharp section-example-container">
      <pre class="csharp">// Get the latest 3 data points of some alternative datasets, packaged into Slice objects.
...
<p>
  ...
  For daily datasets linked to US Equity assets, this results in data points appearing on Saturday and skipping Monday.
</p>
