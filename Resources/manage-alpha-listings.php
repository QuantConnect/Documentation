...
<table class="qc-table table">
   ...
   <tbody>
      <tr>
         <td><span class='column-name'>Review Status</span></td>
         <td>The review status of your Alpha. The following statuses are supported:
            <ul>
                <li>Pending</li>
                <li>Approved</li>
                <li>Rejected</li>
      ...
      <tr>
         <td><span class='column-name'>Deployment Status</span></td>
         <td>The review status of your Alpha. The following statuses are supported:
            <ul>
                <li>In Queue</li>
                <li>Running</li>
