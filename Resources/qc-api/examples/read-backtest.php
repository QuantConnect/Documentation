...
response = post(f'{BASE_URL}/backtests/charts/read', headers=get_headers(), data=data)
# Parse the JSON response into python managable dict
result = response.json()
...
response = post(f'{BASE_URL}/backtests/orders/read', headers=get_headers(), data=data)
# Parse the JSON response into python managable dict
result = response.json()
...
response = post(f'{BASE_URL}/backtests/read/insights', headers=get_headers(), data=data)
# Parse the JSON response into python managable dict
result = response.json()
...
response = post(f'{BASE_URL}/backtests/read/report', headers=get_headers(), data=data)
# Parse the JSON response into python managable dict
result = response.json()
