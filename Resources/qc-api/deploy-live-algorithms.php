...
<div class='section-example-container'>
    <pre class='csharp'>var liveAlgorithm = api.CreateLiveAlgorithm(projectId, compile.CompileId, nodeId, liveSettings);</pre>
    <pre class='python'>new_live_algorithm = api.CreateLiveAlgorithm(project_id, compile.CompileId, node_id, live_settings)</pre>
</div>
...
<div class='section-example-container'>
    <pre class='csharp'>var liveAlgorithm = api.CreateLiveAlgorithm(projectId, compile.CompileId, nodeId, liveSettings, versionId);</pre>
    <pre class='python'>new_live_algorithm = api.CreateLiveAlgorithm(project_id, compile.CompileId, node_id, live_settings, version_id)</pre>
</div>
