<p>
<? if ($cloudPlatform) { ?>The live trading results page has a <span class='button-name'>Stop</span> button to immediately stop your algorithm from executing. <? } ?>
<? if ($leanCliCloud) { ?>The <code>lean cloud live stop</code> command immediately stops your algorithm from executing. 
