...
<ol>
    <? if ($linkScheduledEvents) { ?><li><a href='/docs/v2/writing-algorithms/scheduled-events'>Scheduled Events</a></li>
<li>Consolidation event handlers</li><? } else { ?><li>Scheduled Events</li>
