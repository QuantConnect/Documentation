...
<ol>
    ...
    <li>In the <?=$isCloud ? "right" : "left"?> navigation menu, click the <img class='inline-icon' src='https://cdn.quantconnect.com/i/tu/local-lab-explorer-icon.jpg'> <span class='icon-name'>Explorer</span> icon.</li>
    <li>In the Explorer panel, expand the <span class='button-name'><?=$isCloud ? "Workspace (Workspace)" : "QC (Workspace)"?></span> section.</li>
