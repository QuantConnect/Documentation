...
<ol>
    ...
    <li>In the <?=$isCloud ? "right" : "left" ?> navigation bar, click the <img class='inline-icon' src='https://cdn.quantconnect.com/i/tu/local-lab-explorer-icon.jpg'> <span class='icon-name'>Explorer</span> icon.</li>
