...
<p>To stop a running node, click the <span class='button-name'>stop</span> button next to it. You can stop nodes that you are using, but you need <a href='/docs/v2/cloud-platform/organizations/members#09-Permissions'>stop node permissions</a> to stop nodes other members are using.</p>
