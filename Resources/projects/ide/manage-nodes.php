<p>The Resources panel shows the <?=$isCloud ? "cloud " : ""?>backtesting, research, and live trading nodes within your organization. <?php if ($isCloud) {
 DOCS_VIMEO(696287022); ?></p><p><?php } ?>To view the Resources panel, <a href='<?=$projectLink?>'>open a project</a> and then, in the <?=$isCloud ? "right" : "left"?> navigation menu, click the <img class='inline-icon' src='https://cdn.quantconnect.com/i/tu/resources-icon.png'> <span class='icon-name'>Resources</span> icon.</p>
