<?php
$getAutocompleteText = function($isDesktopDocs)
{
    echo "
...
<p>Use Intellisense to speed up your algorithm development. It works with all of the default class members in Lean, but it doesn't currently support class names or user-defined objects. 
    ";
    if (!$isDesktopDocs)
    {
        echo "
Local auto-complete is also available for <a href='/docs/v2/lean-cli/projects/autocomplete'>select IDEs</a>.
        ";   
    }
    echo "
</p>
