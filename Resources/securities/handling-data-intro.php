<?php
$getIntroText = function($dataFormat) {
    ...
    <p>All the data formats use <code>DataDictionary</code> objects to group data by <code>Symbol</code> and provide easy access to information. The plural of the type denotes the collection of objects. For instance, the <code>{$dataFormat}s</code> <code>DataDictionary</code> is made up of <code>{$dataFormat}</code> objects. To access individual data points in the dictionary, you can index the dictionary with the security ticker or <code>Symbol</code>, but we recommend you use the <code>Symbol</code>.</p>
    ";
}
