...
<p>To get the Option <a href='/docs/v2/writing-algorithms/key-concepts/glossary#17-intrinsic-value'>intrinsic value</a>, call the <code class="csharp">GetIntrinsicValue</code><code class="python">get_intrinsic_value</code> method.</p>
...
<p>To get the Option <a href='/docs/v2/writing-algorithms/key-concepts/glossary#22-out-of-the-money-amount'>out-of-the-money amount</a>, call the <code class="csharp">OutOfTheMoneyAmount</code><code class="python">out_of_the_money_amount</code> method.</p>
