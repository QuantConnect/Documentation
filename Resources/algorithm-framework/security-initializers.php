...
<pre class="csharp">// Disable trading fees on each security by passing CustomSecurityInitializer to SetSecurityInitializer function.
...
<pre class="python">#Disable trading fees on each security by passing _custom_security_initializer to set_security_initializer method.
