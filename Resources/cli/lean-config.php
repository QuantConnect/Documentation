<p>
    ...
    This configuration is created in the <span class="public-file-name">lean.json</span> file when you <?= $leanCli ? "run <code>lean init</code> in an empty directory" : "pull or create an <a href='/docs/v2/local-platform/initialization/organization-workspaces'>organization workspace</a>"?>.
