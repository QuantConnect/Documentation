...
<ol>
<? if($leanCli) { ?>
    <li><a href='/docs/v2/lean-cli/projects/cloud-synchronization#02-Pulling-Cloud-Projects'>Pull all your cloud projects</a> to the current directory, creating directories where necessary.
