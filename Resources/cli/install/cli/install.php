...
{
    echo "
<p>Before you install the LEAN CLI, check if it's already installed. To check if it's already installed, open a terminal and then run <code>lean --version</code>. If the LEAN CLI is already installed, <a href='/docs/v2/lean-cli/installation/installing-lean-cli#03-Stay-Up-To-Date'></a>upgrade it</code> instead of installing it again.</p>
