...
<ol>
    ...
    <p>As you install docker, enable WSL 2 features.</p>
    <li>Restart your computer.</li>
    <li>If Docker prompts you that the WSL 2 installation is incomplete, follow the instructions in the dialog shown by Docker to finish the WSL 2 installation.</li>
