<p>In local deployments, <a href='/docs/v2/writing-algorithms/universes/equity'>Universe Selection</a> is available with the <?=$dataProviderName?> data provider if you download the data from the <a href='/datasets'>Dataset Market</a>. The dataset listings show how to download the universe selection data with the CLI. For live trading, you'll need to periodically download the new data from QuantConnect Cloud, which you can automate with Python scripts. For example, the following tutorials explain how to download historical data and download daily updates:</p>
