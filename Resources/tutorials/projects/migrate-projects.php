<?php
$getMigrateProjectsText = function($textToPrepend="") {
	echo "<p>{$textToPrepend}You need to be the organization manager to migrate projects out of the organization.";
	echo "<ol>
             <li>Open the project.</li>
             <li>In the project panel, click <span class='button-name'>Migrate Project</span>.</li>
