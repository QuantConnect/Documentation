...
$getNavigateCourseIDEText = function($isGettingStarted) {
    echo "<p>The course IDE automatically displays when you <a href='/docs/v2/our-platform/tutorials/learning-center/enrolling-in-courses#03-Enroll-in-Courses'>enrol in a course</a></p>.
