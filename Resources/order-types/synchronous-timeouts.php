<p><?=$orderName?> orders are synchronous by default, so your algorithm waits for the order to fill before moving to the next line of code. If your order takes longer than five seconds to fill, your algorithm continues executing even if the trade isn't filled. To adjust the timeout period, set the <code class="csharp">Transactions.MarketOrderFillTimeout</code><code class="python">transactions.market_order_fill_timeout</code> property.</p>
