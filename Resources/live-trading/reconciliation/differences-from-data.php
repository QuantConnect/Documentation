...
<p>The <a href="/docs/v2/writing-algorithms/getting-started/time-modeling/timeslices">Time Frontier</a> minimizes the risk of look-ahead bias in backtests, but it does not completely eliminate the risk of look-ahead bias. For instance, if you use a <a href="/docs/v2/writing-algorithms/importing-data/getting-started">custom dataset</a> that contains look-ahead bias, your algorithm's live and backtest equity curves may deviate. To avoid look-ahead bias with custom datasets, set a <code>Period</code> on your custom data points so that your algorithm receives the data points after the <code>Time</code> + <code>Period</code>.</p>
