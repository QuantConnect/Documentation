...
<p>To disable automatic exports, set the <code class="csharp">AutomaticExportTimeSpan</code><code class="csharp">automatic_export_time_span</code> property to <code class="csharp">null</code><code class="csharp">None</code></p>
