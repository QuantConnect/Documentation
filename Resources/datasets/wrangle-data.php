...
<p>If the <code class="csharp">History</code><code class="python">history</code> method returns <code>TradeBar</code> objects, iterate through the <code>TradeBar</code> objects to get each one.</p>
<div class='section-example-container'>
...
<p>If the <code class="csharp">History</code><code class="python">history</code> method returns <code>TradeBars</code>, iterate through the <code>TradeBars</code> to get the <code>TradeBar</code> of each <?=$singularAssetClass?>. The <code>TradeBars</code> may not have data for all of your <?=$assetClass?> subscriptions. To avoid issues, check if the <code>TradeBars</code> object contains data for your security before you index it with the <?=$assetClass?> <code>Symbol</code>.</p>
<div class='section-example-container'>
...
<p>If the <code class="csharp">History</code><code class="python">history</code> method returns <code>QuoteBar</code> objects, iterate through the <code>QuoteBar</code> objects to get each one.</p>
<div class='section-example-container'>
...
<p>If the <code class="csharp">History</code><code class="python">history</code> method returns <code>QuoteBars</code>, iterate through the <code>QuoteBars</code> to get the <code>QuoteBar</code> of each <?=$singularAssetClass?>. The <code>QuoteBars</code> may not have data for all of your <?=$assetClass?> subscriptions. To avoid issues, check if the <code>QuoteBars</code> object contains data for your security before you index it with the <?=$assetClass?> <code>Symbol</code>.</p>
<div class='section-example-container'>
...
<? if ($supportsTicks) { ?>
<h4>Tick Objects</h4>
<p>If the <code class="csharp">History</code><code class="python">history</code> method returns <code class="csharp">Tick</code><code class="python">TICK</code> objects, iterate through the <code class="csharp">Tick</code><code class="python">TICK</code> objects to get each one.</p>
<div class='section-example-container'>
...
<p>If the <code class="csharp">History</code><code class="python">history</code> method returns <code>Ticks</code>, iterate through the <code>Ticks</code> to get the <code class="csharp">Tick</code><code class="python">TICK</code> of each <?=$singularAssetClass?>. The <code>Ticks</code> may not have data for all of your <?=$assetClass?> subscriptions. To avoid issues, check if the <code>Ticks</code> object contains data for your security before you index it with the <?=$assetClass?> <code>Symbol</code>.</p>
<div class='section-example-container'>
...
<p>If the <code class="csharp">History</code><code class="python">history</code> method returns <code>OpenInterest</code> objects, iterate through the <code>OpenInterest</code> objects to get each one.</p>
<div class='section-example-container'>
...
<p>The <code class="csharp">OptionHistory</code><code class="python">option_history</code> method returns an <code>OptionHistory</code> object. To get each <a href='/docs/v2/writing-algorithms/key-concepts/time-modeling/timeslices'>slice</a> in the <code>OptionHistory</code> object, iterate through it.</p>
...
<p>The <code class="csharp">FutureHistory</code><code class="python">future_history</code> method returns a <code>FutureHistory</code> object. To get each <a href='/docs/v2/writing-algorithms/key-concepts/time-modeling/timeslices'>slice</a> in the <code>FutureHistory</code> object, iterate through it.</p>
