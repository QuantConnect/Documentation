...
<p>The default resolution for market data is <code class="csharp">Minute</code><code class="python">MINUTE</code>. To set the resolution for a security, pass the <code>resolution</code> argument when you create the security subscription.</p>
