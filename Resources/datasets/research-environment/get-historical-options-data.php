<?php
$getHistoricalDataText = function($createSubscriptionsLink, $optionType, $underlyingSymbolVariable)
{
    echo "
<p>You need a <a href='{$createSubscriptionsLink}'>subscription</a> before you can request historical data for {$optionType} Option contracts. On the time dimension, you can request an amount of historical data based on a trailing number of bars, a trailing period of time, or a defined period of time. On the contract dimension, you can request historical data for a single contract, a subset of the contracts you created subscriptions for in your notebook, or all of the contracts in your notebook.</p>
...
<p>To get historical data for individual {$optionType} Option contracts during a specific period of time, call the <code>History</code> method with the {$optionType} Option contract <code>Symbol</code> object(s), a start  <code class='csharp'>DateTime</code><code class='python'>datetime</code>, and an end <code class='csharp'>DateTime</code><code class='python'>datetime</code>.</p>
...
var subsetHistorySlice = qb.History(new[] {contractSymbol}, startTime, endTime);<br>var allHistorySlice = qb.History(startTime, endTime);

// TradeBar objects
var singleHistoryTradeBars = qb.History&lt;TradeBar&gt;(contractSymbol, startTime, endTime);
var subsetHistoryTradeBars = qb.History&lt;TradeBar&gt;(new[] {contractSymbol}, startTime, endTime);<br>var allHistoryTradeBars = qb.History&lt;TradeBar&gt;(qb.Securities.Keys, startTime, endTime);
...
<p class='python'>To get historical data for all of the {$optionType} Option contracts that pass your <a href='{$createSubscriptionsLink}'>filter</a> during a specific period of time, call the <code>GetOptionHistory</code> method with the underlying {$optionType} <code>Symbol</code> object, a start <code class='csharp'>DateTime</code><code class='python'>datetime</code>, and an end <code class='csharp'>DateTime</code><code class='python'>datetime</code>.</p>
