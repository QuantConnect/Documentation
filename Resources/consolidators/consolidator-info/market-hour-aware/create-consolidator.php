...
<table class='qc-table table'>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>The type of data the consolidator produces. In this case, use <code><?=$this->dataTypeArgPy?></code>.</td>
        </tr>
        <tr>
