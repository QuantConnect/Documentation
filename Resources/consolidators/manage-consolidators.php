		...
		<pre class='csharp'>void ConsolidationHandler(object sender, <?=$dataFormatInfo->consolidationHandlerType?> consolidatedBar)
{
		...
		<pre class='python'>def _consolidation_handler(self, sender: object, consolidated_bar: <?=$dataFormatInfo->consolidationHandlerType?>) -&gt; None:
    pass</pre>
	</div>
	...
	<ul>
		...
		<div class='section-example-container'>
			<pre class='python'>self.subscription_manager.add_consolidator(self._symbol, self._consolidator)</pre>
	...
	<div class='section-example-container'>
		...
		<pre class='python'>self.subscription_manager.remove_consolidator(self._symbol, self._consolidator)</pre>
	</div>
