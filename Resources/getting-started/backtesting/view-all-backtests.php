...
<ol>
    ...
    <li>In the top-right corner of the IDE, click the <?php if ($localPlatform) {?><img class='inline-icon' src='https://cdn.quantconnect.com/i/tu/local-platform-backtest-results-button.png'>/<?php } ?><img class='inline-icon' src='https://cdn.quantconnect.com/i/tu/algorithm-results-icon.jpg'> <span class="icon-name">Backtest Results</span> icon.<br></li>
