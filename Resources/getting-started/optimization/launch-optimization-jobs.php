...
<ul>
    <li>At least one <a href='/docs/v2/writing-algorithms/optimization/parameters#02-Set-Parameters'>algorithm parameter in your project</a>.</li>
    <li>The <a href='/docs/v2/writing-algorithms/optimization/parameters#03-Get-Parameters'>GetParameter</a> method <span class='csharp'>or <code>Parameter</code> attribute </span>in your project.</li>
