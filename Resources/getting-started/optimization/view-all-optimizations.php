...
<ol>
    <? if ($cloudPlatform) { ?><li><a href="/docs/v2/cloud-platform/projects/getting-started#02-View-All-Projects">Open the project</a> that contains the optimization results you want to view.</li><? } ?>
    <li>At the top of the IDE, click the <img class="inline-icon" src="https://cdn.quantconnect.com/i/tu/<? if ($cloudPlatform) { ?>algorithm-results-icon.jpg<? } elseif ($localPlatform) { ?>local-platform-backtest-results-icon.png<? } ?>" alt="Algorithm result icon"> <span class="icon-name">Results</span> icon.</li>
    <p>A table containing all of the backtest and optimization results for the project is displayed. If there is a <span class="icon-name">play</span> icon to the left of the name, it's a <a href="https://www.quantconnect.com/docs/v2/<? if ($cloudPlatform) { ?>cloud<? } elseif ($localPlatform) { ?>local<? } ?>-platform/backtesting/results">backtest result</a>. If there is a <span class="icon-name">fast-forward</span> icon next to the name, it's an <a href="https://www.quantconnect.com/docs/v2/<? if ($cloudPlatform) { ?>cloud<? } elseif ($localPlatform) { ?>local<? } ?>-platform/optimization/results">optimization result</a>.<br></p>
    <img class="docs-image" src="https://cdn.quantconnect.com/i/tu/backtest-results-view-page.png" alt="All backtest table view">
