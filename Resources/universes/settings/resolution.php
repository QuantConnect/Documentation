<p>The <code>Resolution</code> setting defines the <a href='/docs/v2/writing-algorithms/key-concepts/time-modeling/periods'>time period</a> of the asset data. The <code>Resolution</code> enumeration has the following members:</p>
