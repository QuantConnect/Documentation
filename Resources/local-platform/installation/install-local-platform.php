...
<ol>
    ...
    <? if ($os == "mac") { ?>
    <p>If your Mac has an M1 chip, see the additional steps in <a href='/docs/v2/local-platform/installation/install-on-macos#06-Troubleshooting'>Troubleshooting</a>.</p>
    <? } ?>
