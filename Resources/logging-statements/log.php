...
$getLogText = function($isOnOurPlatform) {
    ...
    $result .= "og length is <a href='/docs/v2/our-platform/organizations/resources#09-Log-Quotas'>capped by organization tier</a>. If your organization hits the daily limit, <a href="/contact">contact us</a>. If you log the same content multiple times, only the first instance is added to the log file. Add a timestamp to your log messages to bypass this rate-limiting.</p>";
