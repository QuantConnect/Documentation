...
<p>The following table describes the available order types for each asset class that <?= $cloudPlatform ? "our <a rel='nofollow' target='_blank' href='https://qnt.co/eze'>Eze</a> integration" : "the <code>EzeBrokerageModel</code>" ?> supports:</p>
