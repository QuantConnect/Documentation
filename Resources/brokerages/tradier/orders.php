...
<p><?=$writingAlgorithms ? "The <code>TradierBrokerageModel</code> supports custom order properties." : "We model the Tradier API." ?> The following table describes the members of the <code>TradierOrderProperties</code> object that you can set to customize order execution.</p>
