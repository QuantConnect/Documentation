...
Enter an option:</pre>
    ...
    if ($supportsIQFeed) {
        ...
        echo "
             nter the number of the data feed to use.
            <div class='cli section-example-container'>
<pre>$ lean live 'My Project'
Select a data feed:";
...
Enter an option:</pre>
    ...
    echo "
        ...
        <p>
            If you are using the <a href='/docs/v2/lean-cli/projects/gu'>local GUI</a>, you can make it possible to monitor and control the live deployment through there by providing the <code>--gui</code> flag in step 2.
        </p>
    ";
}
