<? if (!is_null($statusPageURL)) { ?><p>Note the following security and stability aspects of our <?=$brokerageName?> integration.</p>
    <h4>Account Credentials</h4><? } ?>
    <p>When you deploy live algorithms with <?=$brokerageName?>, we don't save your brokerage account credentials.</p>
<? if (!is_null($statusPageURL)) { ?><h4>API Outages</h4>
