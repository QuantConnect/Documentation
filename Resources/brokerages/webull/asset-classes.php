<p><?= $writingAlgorithms ? "The <code>WebullBrokerageModel</code>" : "Our Webull integration" ?> supports the following asset classes:</p>
...
<ul>
    ...
    <li><a href='/docs/v2/writing-algorithms/securities/asset-classes/index'>Index</a></li>
