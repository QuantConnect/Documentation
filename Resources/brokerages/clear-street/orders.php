...
<p>The following table describes the available order types for each asset class that <?= $cloudPlatform ? "our Clear Street integration" : "the <code>ClearStreetBrokerageModel</code>" ?> supports:</p>
...
<p><?=$writingAlgorithms ? "The <code>ClearStreetBrokerageModel</code> supports custom order properties." : "We model custom order properties from the Clear Street API." ?> The following table describes the members of the <code>ClearStreetOrderProperties</code> object that you can set to customize order execution.</p>
    ...
    <tbody>
        <tr>
            ...
            <td>A <a href='/docs/v2/writing-algorithms/trading-and-orders/order-properties#03-Time-In-Force'>TimeInForce</a> instruction to apply to the order. The following instructions are supported:
                ...
                Market orders support only <code class="csharp">Day</code><code class="python">DAY</code>, which the brokerage sets automatically.
            </td>
        ...
        <tr>
            ...
            <td>If set to true, allows orders to also trigger or fill outside of regular trading hours. Clear Street accepts only limit and stop limit orders in the pre-market (4:00 AM to 9:30 AM Eastern Time) and after-hours (4:00 PM to 8:00 PM Eastern Time) sessions.</td>
...
<h4>Updates</h4>
<p><?= $writingAlgorithms ? "The <code>ClearStreetBrokerageModel</code> supports" : "We model the Clear Street API by supporting" ?> <a href='/docs/v2/writing-algorithms/trading-and-orders/order-management/order-tickets#04-Update-Orders'>order updates</a>.</p>
