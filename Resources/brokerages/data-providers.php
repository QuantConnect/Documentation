...
<? if (in_array("US Index Options", $quantConnectAssets)) { ?>
  It also supplies <a href='/docs/v2/cloud-platform/datasets/quantconnect/us-indices'>SPX and VIX Index data</a>, which SPX and VIX Index Options need for the underlying index.
<? } ?>
<? if ($missingAssets) { ?>
