...
$definitionByTerm = array(
    ...
    "risk-free interest rate" => "The interest rate an investor can expect to earn on an investment that carries zero risk such as the interest paid on a 10-year highly rated government treasury note",
    "Sharpe ratio" => "A measure of the risk-adjusted return, developed by William Sharpe.",
    "Sortino ratio" => "A measure of the risk-adjusted return, developed by Frank Sortino. It only penalizes returns falling below a user-specified target or required rate of return.",
