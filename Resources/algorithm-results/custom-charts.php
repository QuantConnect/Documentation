...
<h4>Chart Quotas</h4>
<?     if ($localPlatform) { ?>
<p>If you execute backtests in QuantConnect Cloud, see <a href='/docs/v2/cloud-platform/backtesting/results#07-Custom-Charts'>Custom Charts</a> for more information about the charting quotas.</p>
