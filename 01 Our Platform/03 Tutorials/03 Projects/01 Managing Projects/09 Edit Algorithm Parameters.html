...
<ol>
    ...
    <p>The parameter name must be unique in the project. "Parameter saved" displays.</p>
...
<ol>
    ...
    <img class='docs-image' src="https://cdn.quantconnect.com/i/tu/set-parameter-default-value.jpg">
...
<ol>
    ...
    <img class='docs-image' src="https://cdn.quantconnect.com/i/tu/delete-algorithm-parameter.jpg">
