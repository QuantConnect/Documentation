<p>You must create your dataset listing before you update the documentation.</p>

<p>Make a pull request to the <a href='https://github.com/QuantConnect/Documentation'>Documentation repository</a> with the following changes to add your dataset to the documentation:</p>
<ol>
    ...
    <li>Update the <span class='page-section-name'>Supported Data Formats</span> section of the <a href='/docs/v2/writing-algorithms/historical-data/history-requests'>History Requests</a> tutorial.</li>
</ol>
