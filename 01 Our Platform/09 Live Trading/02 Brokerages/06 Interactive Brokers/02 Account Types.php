...
<p>IB supports cash and margin accounts.</p>


<?php echo file_get_contents(DOCS_RESOURCES."/brokerages/set-brokerage-model/ib.html"); ?>

<h4>FA Accounts</h4>
<p>IB supports FA accounts for Trading Firm and Institution organizations. FA accounts enable certified professionals to use a single trading algorithm to manage several client accounts. For more information about FA accounts, see <a href="#03-Financial-Advisors">Financial Advisors</a>.</p>
...
<p>If you want to use <a href="/docs/v2/our-platform/live-trading/data-feeds/brokerage-data-feeds/interactive-brokers">IB data feeds</a> and trade with your paper trading account, follow these steps:</p>
