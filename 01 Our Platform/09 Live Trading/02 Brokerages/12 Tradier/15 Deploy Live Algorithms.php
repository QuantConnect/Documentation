...
<ol>
    ...
    <table class="qc-table table">
        ...
        <tbody>
            <tr>
                <td>QuantConnect</td>
                <td>Use data collected across all of the exchanges. For more details about this data feed, see <a href="/docs/v2/our-platform/live-trading/data-feeds">Data Feeds</a>.</td>
            </tr>
            <tr>
                <td>Tradier</td>
                <td>Use data sourced directly from Tradier. This data feed isn't available for the demo environment. For more details about this data feed, see the <a href="/docs/v2/our-platform/live-trading/data-feeds/brokerage-data-feeds/tradier">Tradier data feed</a> guide.</td>
            </tr>
        </tbody>
    </table>
