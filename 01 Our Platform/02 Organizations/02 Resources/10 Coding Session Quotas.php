<p>If you have a project open, it uses a coding session. You can have up to one coding session across all of your free organizations. If you connect as an paid organization, you can have multiple coding sessions open. The following table shows how many coding sessions you can have open on each organization tier:</p>
