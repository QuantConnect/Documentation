...
<ol>
    <li><a href="/docs/v2/our-platform/projects/getting-started#02-View-All-Projects">Open the project</a> to which you want to add a parameter.</li>
...
<ol>
    <li><a href="/docs/v2/our-platform/projects/getting-started#02-View-All-Projects">Open the project</a> that contains the parameter for which you want to set a default value.</li>
...
<ol>
    <li><a href="/docs/v2/our-platform/projects/getting-started#02-View-All-Projects">Open the project</a> that contains the parameter you want to delete.</li>
