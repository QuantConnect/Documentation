<p>
  <a href='/docs/v2/writing-algorithms/universes/key-concepts'>Universe selection</a> is available with the Polygon data provider if you download the data from the <a href='/datasets'>Dataset Market</a>. 
