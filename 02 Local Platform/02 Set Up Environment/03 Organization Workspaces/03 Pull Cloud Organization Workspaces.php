...
<ol>
    <li><a href="/docs/v2/local-platform/set-up-environment/accounts#02-Log-In">Log in to the local platform</a>.</li>
...
<p>It takes a few minutes to create a new workspace directory and populate it with the <a href='/docs/v2/local-platform/set-up-environment/organization-workspaces#05-Directory-Structure'>the initial file structure</a>. After the workspace directory is populated with the initial file structure, it pulls <a href='https://www.quantconnect.com/docs/v2/cloud-platform/projects/getting-started#02-View-All-Projects'>your cloud project files</a>.</p>
