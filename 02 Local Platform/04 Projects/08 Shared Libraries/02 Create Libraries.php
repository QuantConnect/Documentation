...
<ol>
    ...
    <p>The template library files are added to a new project in the <span class='private-file-name'>Library</span> directory in your <a href='/docs/v2/local-platform/initialization/workspace'>workspace</a>.</p>
