...
| `QuiverInsiderTrading` | Insider Trading | `Date`, `FileDate`, `TransactionCode`, `PricePerShare`, `Shares`, `SharesOwnedFollowing`, `AcquiredDisposedCode`, `DirectOrIndirectOwnership`, `OfficerTitle`, `IsDirector`, `IsOfficer`, `IsTenPercentOwner`, `IsOther` |
