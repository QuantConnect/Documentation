...
.. raw:: html
    ...
    <div class="flex-column qc-doc-header">
        <div class="flex-center docs-margin-small">
            ...
            <p class="docs-title">Writing Algorithms Documentation</p>
        </div>
    ...
    <div class="flex-column">
        <div class="flex-center docs-section-icon docs-margin-small">
         ...
         <p  class="docs-p" style="margin-bottom: 75px;">Learn about creating algorithms in QuantConnect.</p>
    </div>
        ...
        <a href='getting-started/index.html'>
            <div class="flex-center docs-section-icon">
                ...
                <div class="flex-column">
                    ...
                    <p class="docs-p docs-p-small">Get acquainted with the basics of creating trading algorithms.</p>
                </div>
            </div>
        </a>
         <a href='tutorials/index.html'>
           <div class="flex-center docs-section-icon">
                ...
                <div class="flex-column">
                    ...
                    <p class="docs-p docs-p-small ">Practice implementing beginner to advanced algorithms through interactive tutorials.</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href='user-guides/index.html'>
            <div class="flex-center docs-section-icon">
                ...
                <div class="flex-column">
                    ...
                    <p class="docs-p docs-p-small">Read guides to help you get started, optimize, and troubleshoot your algorithms.</p>
                </div>
            </div>
        </a>
