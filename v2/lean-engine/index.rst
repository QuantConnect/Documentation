...
.. raw:: html
    ...
    <div class="flex-column qc-doc-header">
        <div class="flex-center docs-margin-small">
            ...
            <p class="docs-title">LEAN Engine Documentation</p>
        </div>
    ...
    <div class="flex-column">
        <div class="flex-center docs-section-icon docs-margin-small">
         ...
         <p  class="docs-p" style="margin-bottom: 75px;">Learn about the LEAN Engine, QuantConnect’s open-source algorithmic trading engine.</p>
    </div>
        ...
        <a href='getting-started/index.html'>
            <div class="flex-center docs-section-icon">
                ...
                <div class="flex-column">
                    ...
                    <p class="docs-p docs-p-small">Get acquainted with the LEAN engine, installation, and basic features.</p>
                </div>
            </div>
        </a>
         <a href='tutorials/index.html'>
           <div class="flex-center docs-section-icon">
                ...
                <div class="flex-column">
                    ...
                    <p class="docs-p docs-p-small ">Learn how to use LEAN for strategy research, backtesting, and live trading through guided tutorials.</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href='user-guides/index.html'>
            <div class="flex-center docs-section-icon">
                ...
                <div class="flex-column">
                    ...
                    <p class="docs-p docs-p-small">Read guides about the usage and applications of working with LEAN.</p>
                </div>
            </div>
        </a>
