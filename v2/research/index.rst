...
.. raw:: html
    ...
    <div class="flex-column qc-doc-header">
        <div class="flex-center docs-margin-small">
            ...
            <p class="docs-title">Research Environment Documentation</p>
        </div>
    ...
    <div class="flex-column">
        <div class="flex-center docs-section-icon docs-margin-small">
         ...
         <p  class="docs-p" style="margin-bottom: 75px;">Learn about QuantConnect’s Research environment.</p>
    </div>
        ...
        <a href='getting-started/index.html'>
            <div class="flex-center docs-section-icon">
                ...
                <div class="flex-column">
                    ...
                    <p class="docs-p docs-p-small">Get acquainted with the Research environment and basic features.</p>
                </div>
            </div>
        </a>
         <a href='tutorials/index.html'>
           <div class="flex-center docs-section-icon">
                ...
                <div class="flex-column">
                    ...
                    <p class="docs-p docs-p-small ">Learn how to use the Research environment to perform exploratory research, brainstorm new ideas for algorithms, and explore available data.</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href='user-guides/index.html'>
            <div class="flex-center docs-section-icon">
                ...
                <div class="flex-column">
                    ...
                    <p class="docs-p docs-p-small">Read guides about the usage and applications of the Research environment.</p>
                </div>
            </div>
        </a>
