...
<p>The Universe Selection model may select a dynamic universe of assets, so you should not assume a fixed set of assets in the Execution model. When the Universe Selection model adds and removes assets from the universe, it triggers an <code>OnSecuritiesChanged</code> event. In the <code>OnSecuritiesChanged</code> event handler, you can initialize the security-specific state or load any history required for your Execution Model.</p>



<div class="section-example-container">
		<pre class="csharp">class MyExecutionModel : ExecutionModel
{
    ...
    public class SymbolData 
    {
		...
		<pre class="python">class MyExecutionModel(ExecutionModel):
