...
<p>This model uses the default Option filter, which selects the Option contracts with the following characteristics:</p>

<?php echo file_get_contents(DOCS_RESOURCES."/universes/option/default-filter.html");?>

<p>To use a different filter for the contracts, subclass the <code>OptionUniverseSelectionModel</code> and define a <code>Filter</code> method. The <code>Filter</code> method must accept and return an <code>OptionFilterUniverse</code> object. For a full example, see the <span class="python"><a target="_blank" rel="nofollow" href="https://github.com/QuantConnect/Lean/blob/master/Algorithm.Python/BasicTemplateOptionsFrameworkAlgorithm.py">BasicTemplateOptionsFrameworkAlgorithm</a></span><span class="csharp"><a target="_blank" rel="nofollow" href="https://github.com/QuantConnect/Lean/blob/master/Algorithm.CSharp/BasicTemplateOptionsFrameworkAlgorithm.cs">BasicTemplateOptionsFrameworkAlgorithm</a></span>.</p> 
