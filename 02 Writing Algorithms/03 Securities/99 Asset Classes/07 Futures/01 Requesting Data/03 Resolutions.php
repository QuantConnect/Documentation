...
<p>The default resolution for Futures contract subscriptions is <code>Resolution.Minute</code>. To change the resolution, pass a <code>resolution</code> argument to the <code>AddFutureContract</code> method.</p>

<div class="section-example-container">
    <pre class="csharp">AddFutureContract(_contractSymbol, Resolution.Daily);</pre>
    <pre class="python">self.AddFutureContract(self.contract_symbol, Resolution.Daily)</pre>
</div>
