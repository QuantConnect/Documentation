...
<div class="section-example-container">
    <pre class="csharp">var adjustedPrice = Securities[_future.Symbol].Price; // Adjusted price of the continuous contract
var rawPrice = Securities[_future.Mapped].Price; // Raw price of the currently selected contract in the continuous contract series</pre>
    <pre class="python">adjusted_price = self.Securities[self.future.Symbol].Price # Adjusted price of the continuous contract
raw_price = self.Securities[self.future.Mapped].Price # Raw price of the currently selected contract in the continuous contract series</pre>
</div>
