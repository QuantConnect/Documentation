<p>Coarse Universe Selection enables you pick a set of stocks based on their trading volume, price, or whether they have fundamental data. To add a coarse universe, in the <code>Initialize</code> method, pass a filter function to the <code>AddUniverse</code> method. The coarse filter function receives a list of <code>CoarseFundamental</code> objects and must return a list of <code>Symbol</code> objects. LEAN automatically subscribes to the <code>Symbol</code> objects you return from the function. You shouldn't call <code>AddEquity</code> in the filter function.</p>
