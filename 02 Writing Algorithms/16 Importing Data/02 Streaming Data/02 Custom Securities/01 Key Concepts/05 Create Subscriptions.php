<p>After you define the custom data class, in the <code>Initialize</code> method of your algorithm, call the <span class="csharp"><code>AddData&lt;T&gt;(string ticker, Resolution resolution = Resolution.Daily)</code> method. This method gives LEAN the T-type factory to create the objects, the name of the data, and the resolution at which to poll the data source for updates.</span> <span class="python"><code>self.AddData(Type class, string ticker, Resolution resolution = Resolution.Daily)</code> method. This method gives LEAN the type factory to create the data objects, the name of the data, and the resolution to poll the data source for updates.</span></p>
