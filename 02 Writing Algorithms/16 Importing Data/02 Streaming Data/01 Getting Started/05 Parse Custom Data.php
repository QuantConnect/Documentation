...
<table class="qc-table table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>The time when the data sample ends and when LEAN should add the sample to a <a href="/docs/v2/writing-algorithms/getting-started/time-modeling/timeslices">Slice</a>.</td>
        </tr>
        <tr>
