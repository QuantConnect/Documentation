...
<div>-Tick trade Definition: a record of a transaction or sale for the security</div><div>-Contains Quantity and Price values</div><div>-Useful for HFT strategies (co-located servers if deploy with QC)<br></div><div></div>
