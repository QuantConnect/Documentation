...
<div class="section-example-container">
    <pre class="csharp">filteredFine = fine.Where(x =&gt; x.AssetClassification.MorningstarSectorCode == MorningstarSectorCode.Technology);<pre class="python"></pre>
    <pre class="python">filtered_fine = [x for x in fine if x.AssetClassification.MorningstarSectorCode == MorningstarSectorCode.Technology]<pre class="python"></pre>
</div>
...
<div class="section-example-container">
    <pre class="csharp">filteredFine = fine.Where(x =&gt; x.AssetClassification.MorningstarIndustryGroupCode == MorningstarIndustryGroupCode.ApplicationSoftware);<pre class="python"></pre>
    <pre class="python">filtered_fine = [x for x in fine if x.AssetClassification.MorningstarIndustryGroupCode == MorningstarIndustryGroupCode.ApplicationSoftware]<pre class="python"></pre>
</div>
...
<div class="section-example-container">
    <pre class="csharp">filteredFine = fine.Where(x =&gt; x.AssetClassification.MorningstarIndustryCode == MorningstarIndustryCode.SoftwareApplication);<pre class="python"></pre>
    <pre class="python">filtered_fine = [x for x in fine if x.AssetClassification.MorningstarIndustryCode == MorningstarIndustryCode.SoftwareApplication]<pre class="python"></pre>
</div>
...
<div class="section-example-container">
    <pre class="csharp">filteredFine = fine.Where(x =&gt; x.CompanyReference.PrimaryExchangeID == "NAS");<pre class="python"></pre>
    <pre class="python">filtered_fine = [x for x in fine if x.CompanyReference.PrimaryExchangeID == "NAS"]<pre class="python"></pre>
</div>
