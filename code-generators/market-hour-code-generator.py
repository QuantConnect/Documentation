...
'''.replace("US Option", "Equity Option").replace("IndexOption", "Index Option"))
            ...
            for page_name, hour_list in {"pre-market-hours": premarket_html, "regular-trading-hours": market_html, "post-market-hours": postmarket_html}.items():
...
for asset_class in ["Index", "IndexOption"]:
    with open(destination_folder / asset_class.lower() / "usa" / "generic"/ "regular-trading-hours.html", "w", encoding="utf-8") as html_file:
        exchange = "usa"
