<p>
    <span class='csharp'>To get daily data on all the tradable contracts for a given date, call the <code class='csharp'>History&lt;FutureUniverse&gt;</code> method with the continuous Futures contract <code>Symbol</code>.</span>
    <span class='python'>
