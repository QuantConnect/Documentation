...
<p>When you request historical data, the <code class="charp">History</code><code class="python">history</code> method uses the data normalization of your security subscription. To get historical data with a different data normalization, pass a <code>dataNormalizationMode</code> argument to the <code class="charp">History</code><code class="python">history</code> method.</p>
