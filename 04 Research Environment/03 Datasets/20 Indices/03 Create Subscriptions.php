...
?>
    ...
    <li>Call the <code class="csharp">AddIndex</code><code class="python">add_index</code> method with a ticker and then save a reference to the Index <code>Symbol</code>.</li>
    <div class="section-example-container">
...
<p>To view all of the available indices, see <a href="/docs/v2/writing-algorithms/datasets/quantconnect/cash-indices#10-Supported-Indices">Supported Indices</a>.</p>