<p>
    ...
    The logs of the backtest are shown in real-time and the full results are stored in the <span class="public-directory-name">&lt;project&gt; / backtest / &lt;timestamp&gt;</span> directory.
...
<p>
    ...
    If it is a project directory, the CLI looks for a <span class="public-file-name">main.py</span> or <span class="public-file-name">Main.cs</span> file, assuming the first file it finds to be the algorithm to run.
</p>
