<p>
  <a href='https://www.quantconnect.com/docs/v2/writing-algorithms/universes/equity'>Universe selection</a> is available with the Alpha Vantage data provider if you download the data from the <a href='/datasets'>Dataset Market</a>. 
