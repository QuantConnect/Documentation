<p>
  In local deployments, <a href='https://www.quantconnect.com/docs/v2/writing-algorithms/universes/key-concepts'>universe selection</a> is available with the Polygon data provider if you download the data from the <a href='/datasets'>Dataset Market</a>. 
