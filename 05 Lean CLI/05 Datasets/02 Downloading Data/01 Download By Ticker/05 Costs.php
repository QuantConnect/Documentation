...
<h4>India Equity</h4>
<p>India Equity algorithms require the <a href="https://www.quantconnect.com/contact">India Equity Security Master</a> and some data from the <a href="https://www.quantconnect.com/contact">India Equities</a> dataset. If you have a LEAN CLI subscription, the India Equity Security Master is free. The India Equities dataset is available is several resolutions. The resolution you need depends on the India Equity subscriptions you create in your algorithm and the resolution of data you get in <a href="https://www.quantconnect.com/docs/v2/writing-algorithms/historical-data/history-requests">history requests</a>. The following table describes the file format and costs of each resolution:</p>
...
<table class="qc-table table">
    ...
    <tbody>
        <tr>
            <td>Minute</td>
            <td>One file per security per trading day.</td>
            <td>4 QCC = $0.04 USD</td>
        </tr>
        <tr>
            <td>Hour</td>
            <td>One file per security.</td>
...
<p>For example, the following algorithm subscribes to minute resolution data for one security:</p>
...
<pre class="python">class IndiaEquityDataAlgorithm(QCAlgorithm):
    def Initialize(self) -&gt; None:
        self.SetStartDate(2020, 1, 1)
        self.SetEndDate(2021, 1, 1)
        self.AddEquity("YESBANK", market=Market.India)</pre>
</div>
...
<table class="qc-table table">
    ...
    <tbody>
        <tr>
            <td>India Equity Security Master</td>
            <td>Download On Premise</td>
            <td>$0 USD</td>
            <td>$0 USD</td>
        </tr>
        <tr>
            <td>India Equity</td>
            <td>Minute Download</td>
            <td>1 security over 252 trading days<br>=&gt; 252 files<br><br>252 files @ 4 QCC/file<br>=&gt; 1,008 QCC<br>= $10.08 USD</td>
            <td>1 security<br>=&gt; 1 file/day<br><br>1 file/day @ 4 QCC/file<br>=&gt; 4 QCC/day<br>= $0.04 USD/day<br></td>
        </tr>
    </tbody>
</table>
