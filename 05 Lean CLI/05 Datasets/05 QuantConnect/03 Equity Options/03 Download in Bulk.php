...
<p>The dataset also depends on the underlying US Equities data; to download it, see <a href="/docs/v2/lean-cli/datasets/quantconnect/us-equity#03-Download-in-Bulk">US Equity</a>. You can also use the <a href="https://www.quantconnect.com/datasets/algoseek-us-equity-options/cli">CLI Command Generator</a>. For more information, see <a href="/docs/v2/lean-cli/datasets/quantconnect/key-concepts#03-Using-the-CLI">Using the CLI</a>.</p>
