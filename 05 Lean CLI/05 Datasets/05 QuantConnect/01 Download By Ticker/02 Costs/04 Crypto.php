<p>Crypto algorithms require at least one of the <a href="https://www.quantconnect.com/docs/v2/writing-algorithms/datasets/coinapi">CoinAPI datasets</a>. The CoinAPI datasets are available in several resolutions. The resolution you need depends on the Crypto subscriptions you create in your algorithm and the resolution of data you get in&nbsp;<a href="https://www.quantconnect.com/docs/v2/writing-algorithms/historical-data/history-requests">history requests</a>. The following table describes the file format and costs of each resolution:</p>
