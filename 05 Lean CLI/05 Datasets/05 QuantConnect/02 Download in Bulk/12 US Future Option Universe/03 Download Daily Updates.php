<p>
	...
	To unlock local access to the data updates, open the <a href="https://www.quantconnect.com/pricing">Pricing</a> page of your organization and subscribe to the <span class="button-name">US Future Option Universe Updates by QuantConnect</span> data package.
...
<p>
	After you subscribe to dataset updates, to update your local copy of the US Future Option Universe dataset, use the <a href="https://www.quantconnect.com/datasets/quantconnect-us-future-option-universe/cli">CLI Command Generator</a> to generate your download command and then run it in a terminal in your <a href="https://www.quantconnect.com/docs/v2/lean-cli/initialization/organization-workspaces">organization workspace</a>. 
  To update your local copy of the US Future Universe, see <a href='/docs/v2/lean-cli/datasets/quantconnect/download-in-bulk/us-future-universe#03-Download-Daily-Updates'>Download Daily Updates</a>.
