<p>
  In local deployments, <a href='/docs/v2/writing-algorithms/universes/key-concepts'>universe selection</a> is available with Terminal Link if you download the data from the <a href='/datasets'>Dataset Market</a>. 
