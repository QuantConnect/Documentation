...
<p>
    ...
    To use data from QuantConnect Cloud, a brokerage, or a third-party data provider, include the <code>--data-provider-historical</code> option.
    To view what brokerages and third-party data providers are available, see <a href='/docs/v2/lean-cli/api-reference/lean-optimize'>the reference page for this command</a>.
</p>
