    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                The CLI automatically tries to find this file by recursively looking in the current directory and all of the parent directories for a <span class="private-file-name">lean.json</span> file.
                This error is shown if no such file can be found.
                It can be fixed by running the command in your <a href='/docs/v2/lean-cli/initialization/workspace'>workspace directory</a> (which generates the <span class="private-file-name">lean.json</span> file), or by specifying the path to the <span class="private-file-name">lean.json</span> file with the <code>--lean-config</code> option.
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <div class="error-messages">invalid mount config for type "bind": bind source path does not exist: /var/folders/&lt;path&gt;/config.json</div>
                <br>
                <div class="error-messages">Mounts denied: The path /Users/&lt;path&gt;/data is not shared from the host and is not known to Docker</div>
            </td>
            <td>
                ...
                Go to Docker's <span class="menu-name">Settings &gt; Resources &gt; File Sharing</span> and add <span class="private-directory-name">/private/var/folders</span> and either <span class="private-directory-name">/Users</span>
                to share your entire <span class="private-directory-name">/Users</span> directory, or <span class="private-file-name">/Users/&lt;path&gt;</span> where <span class="private-file-name">&lt;path&gt;</span> is the path to your QuantConnect directory, which should have
                a <span class="private-directory-name">data</span> child directory, and child directories for your individual projects.
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                To do so, open your Docker settings, go to <span class="menu-name">Resources &gt; File Sharing</span> and add <span class="private-file-name">C:/Users/&lt;username&gt;/AppData/Local/Temp</span> and your workspace directory to the list.
