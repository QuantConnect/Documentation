...
<p>You can manually create security subscriptions for your algorithm instead of calling the <code>Add<span class="placeholder-text">securityType</span></code> methods in your code files. If you add security subscriptions to your algorithm, you can place manual trades without having to edit and redeploy the algorithm. To add security subscriptions, open a terminal in the <a href='/docs/v2/lean-cli/initialization/workspace'>workspace</a> that contains the project and then run <code>lean live add-security "My Project"</code>.</p>
...
<p>To submit orders, open a terminal in the <a href='/docs/v2/lean-cli/initialization/workspace'>workspace</a> that contains the project and then run <code>lean live submit-order "My Project"</code>.</p>
...
<h4>Update Orders</h4>
<p>To update an existing order, open a terminal in the <a href='/docs/v2/lean-cli/initialization/workspace'>workspace</a> that contains the project and then run <code>lean live update-order "My Project"</code>.</p>
<div class="cli section-example-container">
...
<p>To cancel an existing order, open a terminal in the <a href='/docs/v2/lean-cli/initialization/workspace'>workspace</a> that contains the project and then run <code>lean live cancel-order "My Project"</code>.</p>
<div class="cli section-example-container">
...
<p>To liquidate a specific asset in your algorithm, open a terminal in the <a href='/docs/v2/lean-cli/initialization/workspace'>workspace</a> that contains the project and then run <code>lean live liquidate "My Project"</code>.</p>
...
<p>To stop an algorithm, open a terminal in the <a href='/docs/v2/lean-cli/initialization/workspace'>workspace</a> that contains the project and then run <code>lean live stop "My Project"</code>.</p>
<div class="cli section-example-container">
