...
<h4>Update Orders</h4>
<p>To update an existing order, open a terminal in your <a href='/docs/v2/lean-cli/initialization/directory-structure#02-lean-init'>CLI root directory</a> and then run <code>lean live update-order "My Project"</code>.</p>
<div class="cli section-example-container">
...
<p>To cancel an existing order, open a terminal in your <a href='/docs/v2/lean-cli/initialization/directory-structure#02-lean-init'>CLI root directory</a> and then run <code>lean live cancel-order "My Project"</code>.</p>
<div class="cli section-example-container">
...
<p>To liquidate a specific asset in your algorithm, open a terminal in your <a href='/docs/v2/lean-cli/initialization/directory-structure#02-lean-init'>CLI root directory</a> and then run <code>lean live liquidate "My Project"</code>.</p>
