...
$dataFeedDetails = "
        <p>
            ...
            To avoid data issues with the benchmark security, either <a href='/docs/v2/writing-algorithms/importing-data/streaming-data/custom-securities/getting-started#07-Set-the-Benchmark'>set the benchmark to the subscribed custom data</a> or a constant.
        </p>
