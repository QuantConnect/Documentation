...
$dataFeedDetails = "
        <p>
            ...
            To avoid data issues with the benchmark security, either <a href='https://www.quantconnect.com/docs/v2/writing-algorithms/importing-data/streaming-data/custom-securities/key-concepts#07-Set-the-Benchmark'>set the benchmark to the subscribed custom data</a> or a constant.
        </p>
