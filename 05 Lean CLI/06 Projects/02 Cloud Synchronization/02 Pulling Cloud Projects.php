<p>
    Follow these steps to pull all the cloud projects that you store in an <a href='/docs/v2/our-platform/organizations/getting-started'>organization</a> to your local drive:
</p>
...
<ol>
    ...
    <li>Run <code>lean cloud pull --project "&lt;projectName&gt;"</code> to pull the project named "&lt;projectName&gt;" to <span class="private-directory-name">./&lt;projectName&gt;</span>.
<div class="cli section-example-container">
