...
<div class="docs-tutorial">
    ...
    <p style="margin-top: 2rem;">
      ...
      Behind them all, our Agent servers act as a harness for quant finance: they wrap your AI models in the tools, data, and project context they need to do real research, making whichever model you choose far more productive.
    </p>
    ...
    <h4>QuantConnect Agents</h4>
    <p><a href="/docs/v2/ai-assistance/agents">Agents</a> are AI specialists that handle the distinct stages of building a trading strategy. They source ideas, validate them, code the backtest, and shepherd the result through paper trading. Each one focuses on a single part of the workflow and has the tools to do the work rather than just describe it. Talk to an agent directly, or hand the whole job to the Conductor and let it route the work through the team on your behalf.</p>
    <p>To supercharge your productivity, add agents to your <a href="/docs/v2/cloud-platform/research-pipeline">Research Pipeline</a>, a kanban board that tracks your projects through the stages of research validation, backtesting, paper trading, and live trading.</p>


    <hr />
    <h4>Follow these steps to create and deploy a new strategy to paper trading with the help of the Agents:</h4>
    ...
    <div class="tutorial-step">
        ...
        <p>Congratulations! You've just deployed your first agent. Mia will read your description and then get to work researching the idea and writing code.</p>
    </div>
    <div class="tutorial-step">
